...
def autogenerate_readme(
    *,
    ...
    readme_comment = """<!--- NOTE! THIS FILE IS AUTOMATICALLY GENERATED, IF YOU ARE READING THIS, YOU ARE EDITING THE WRONG FILE --->"""
    ...
    if (
        ...
        try:
            ...
            if remote and Path(edit_config.parent / Path(".push_enabled")).is_file():
                ...
                ic(
                    ".push_enabled not found: push is not enabled, changes comitted locally"
                )
